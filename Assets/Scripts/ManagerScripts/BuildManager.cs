...
public class BuildManager : MonoBehaviour
{
    ...
    public void ShowRoomPositionSelectors(GridIndex[] indexArray, Enums.RoomTypes roomType, Enums.RoomSizes roomSize)
    {
        ...
        for (int i = 0; i < indexArray.Length; i++)
        {
            ...
            go.transform.GetComponent<BuildPositionScript>().SetRoomInfoData(roomSize, roomType, indexArray[i]);
            go.SetActive(true);
    ...
    public void Build_Finished(Enums.RoomSizes roomSize, Enums.RoomTypes roomType, GridIndex index)
    {
