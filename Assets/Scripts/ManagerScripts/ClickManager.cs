...
public class ClickManager : MonoBehaviour
{
    ...
    private void InitiateBuilding(Enums.RoomSizes RoomSize, Enums.RoomTypes RoomType)
    {
        ...
        BuildManager.Ref.ShowRoomPositionSelectors(BuildingIndexArray, RoomType, RoomSize);
    }    
