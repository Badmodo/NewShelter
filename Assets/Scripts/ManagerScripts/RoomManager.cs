...
public class RoomManager : MonoBehaviour
{
    ...
    {
        RoomDefData RoomDefData = RoomFactory.Ref.GetRoomDefData(roomType, roomSize);
    ...
    public void CreateRoom(RoomInstanceData roomData)
    {
        ...
        GameObject RoomObject = RoomFactory.Ref.CreateRoom(roomData.RoomType, roomData.RoomSize);
    ...
    {
        RoomScript RoomScript = _RoomList[roomId].RoomScript;
        return (RoomScript.RoomData.GetLeftMostIndex() == Constants.EntranceRoomIndex);
    }
